...
# Quarterly Connection Agent — Knowledge Base

Content map for the QC agent's memory stores. Read this index first, then navigate to the relevant store.
...
- `patterns/` — Learned patterns: writing preferences, team growth trajectories. **Consolidation only.** Read when drafting reports to apply learned style.

## Project file

- [quarterly-connection-agent.md](../quarterly-connection-agent.md) — Project context, architecture, plan, design decisions.
