...
- **[AutoSD Upstream HW Testing](autosd-jumpstarter-hw-testing.md)** — Running AutoSD nightly tests on Jumpstarter real hardware. Paul Wallrabe proposal, topic for ATC open sync. Read when AutoSD nightly testing, upstream HW testing, or Jumpstarter integration comes up.
