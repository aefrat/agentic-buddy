...
| Problem Solving | Experienced | Experienced | OIDC CA certificate support required solving security integration across two subsystems (builder + jumpstarter). CTC junit XML generation solved reporting gap. |
| Customer Focus | Experienced | Developing-Experienced | Ford x86_64 qemu lab support shows direct customer awareness. Most work is infrastructure-facing rather than customer-facing. |
| Continuous Learning | Experienced | Developing | No evidence of AI tool adoption, conference attendance, or knowledge sharing artifacts (blog posts, design docs). |
...
3. **Business impact framing** (maps to: securing 3+ automotive customer wins). The Ford qemu lab support is direct customer impact - Bella should practice connecting her technical work to business outcomes in Jira tickets and status updates. This develops the Customer Focus competency and makes her contributions visible to program leadership.

4. **AI tool adoption** (maps to: Agentic SDLC transformation). No evidence of AI tool usage this quarter. Experimenting with AI-assisted code review, test generation, or documentation would develop Continuous Learning and align with the program's agentic SDLC direction.

## f. 1:1 talking points

1. "You've become our CTC reporting specialist this quarter. Is that a role you want to grow into formally, or would you prefer to diversify? What would 'owning CTC end-to-end' look like to you?"
...
5. "Where are you with AI tools in your daily workflow? The program is pushing toward agentic SDLC - I want to make sure you have time and support to experiment."
...
4. **Increase cross-team Slack engagement.** Set a lightweight goal: one substantive message per week in a cross-team channel (forum-jumpstarter, a Konflux channel, or a testing forum). Builds Influence competency.

5. **Experiment with one AI tool for testing or code review** (maps to: Agentic SDLC transformation). Pick one AI tool and try it on a real task this quarter. Document what worked and what didn't - this builds both Continuous Learning and knowledge-sharing evidence.
