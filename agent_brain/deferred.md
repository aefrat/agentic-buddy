...
- **reminder** (2026-06-18, daily): Manager report cron auth still broken — `claude -p` in cron lacks Vertex AI env vars. Fix reverted at user request on June 16. Still needs resolution.
