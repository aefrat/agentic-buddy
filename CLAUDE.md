...
- **Overdue administrative actions.** Workday manager evaluations 44+ days past deadline (Jul 10). CY27 Capex deadline passed (Aug 14) - check team submission status. Stuart Corcoran (Lightwell EM) needs response to Aug 14 email. PDR Talent Calibration outcome (Jul 23) still unknown.
- **Active retention/onboarding work.** Kanitha mentor finalization overdue (~26 days since due date ~Jul 28). Hubert Stefanski KT plan still pending (day 54 of transition). Roderick Kieley PITCREW-294 timeline discussion needed (returned from PTO Aug 4, day 19 back).
