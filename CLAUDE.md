...
- **Aman Vishwakarma onboarding day 4 (started Jul 18).** Intern conversion to ATC (RHIVOS Toolchain). Christine Freitas (manager) OOO until Jul 27 - user designated as primary onboarding contact. Aman needs badge and laptop. Also key for Kanitha distribution offloading.
...
- **Roderick Kieley** — 51 days into onboarding (started Jun 1). 30-day checkpoint 21 days overdue. SPSE (L5) development profile ready at `talent-architecture/active/roderick.kieley/`. PITCREW-294 due Jul 28, Roderick PTO Jul 27-Aug 3 - needs wrap-up before leave.
