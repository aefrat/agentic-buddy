...
|------|-------------|------------|
| 2026-09-03 | Release blocker agent: implemented + shipped Core/FuSa split (Whitney Chadwick fixes, VROOM-49388) - per-track sections/filtering/status, target dates live from Jira fixVersion releaseDate with "Not set in Jira", ruff+8/8 tests, committed e240100, republished 4 live G-Docs, pinged Whitney, deleted [REVIEW] copies. Then: dropped bespoke "submission" status (unsourced, self-coined) -> two-status model Released/Active, commit bcb9166; added visible status legend to Program doc (Google Docs can't do hover tooltips), commit + republish; noted per-track state-file .gitignore gap. Jira URL on "Needs Attention" column still pending. | 0d0251f7-1321-422d-baf0-4923fd3a7943 |
